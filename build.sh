...
docker buildx build --push --platform linux/amd64,linux/arm64 --tag hussainweb/drupal-base:php8.0 --build-arg PHP_VERSION=8.0-apache-buster ${dir}/php7.4/apache/
docker buildx build --push --platform linux/amd64,linux/arm64 --tag hussainweb/drupal-base:php8.1 --tag hussainweb/drupal-base:latest --build-arg PHP_VERSION=8.1-apache-buster ${dir}/php7.4/apache/
